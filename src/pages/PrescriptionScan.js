...
const PrescriptionScan = ({route}) => {
  ...
  const handleSubmit = () => {
    ...
    // Home.js로 mockMedicine을 함께 전달
    navigation.navigate('Home', {
      mockMedicine: mockMedicine,
    });
  };
  ...
  const ListHeaderComponent = () => (
    <View style={styles.headerContainer}>
      ...
      {avatar ? (
        ...
        <Image
          style={styles.image}
          source={require('../../assets/image/prescription.jpg')}
        />
      )}
      <View style={styles.info_container}>
        <View style={styles.info_item1}>
          ...
          <View style={styles.date}>
            <Text style={styles.dateText}>{request.prescriptionDate}</Text>
    ...
    <FlatList
      ...
      ListFooterComponent={
        <View style={styles.alertContainer}>
          ...
          <Text onPress={handleSubmit} style={styles.done_btn}>
            완료
          </Text>
        </View>
      }
