...
export const AddMedicine = async request => {
  ...
  const jwtToken =
    "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyMTIxMjEyMjIyQGV4YW1wbGUuY29tIiwiaWF0IjoxNzIzODg1MDg2LCJleHAiOjE3MjM4ODY4ODZ9.29lv1aNDLF5jUNyDHDbPymeYM45kzUH7Tptn0w2v9_I";
